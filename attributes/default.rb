...
when "windows"
  ...
  when 'x86_64'
    default['java']['windows']['url']  = "http://download.oracle.com/otn-pub/java/jdk/7u71-b14/jdk-7u71-windows-x64.exe"
    default['java']['windows']['package_name'] = "Java(TM) SE Development Kit 7 (64-bit)"
  when 'i386'
    default['java']['windows']['url']  = "http://download.oracle.com/otn-pub/java/jdk/7u71-b14/jdk-7u71-windows-i586.exe"
    default['java']['windows']['package_name'] = "Java(TM) SE Development Kit 7 (32-bit)"
  end  
    default['java']['windows']['checksum'] = nil
# In case of Oracle Download URL, set true to below attribute to accept the License 
default['java']['installer_License']       = true
